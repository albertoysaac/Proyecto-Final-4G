...
from .models import db, Usuarios,Tienda,Producto,Categoria, Inventario, Ticket, DetalleTicket, AdminTiendas, Horario
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(DetalleTicket,db.session))
    admin.add_view(ModelView(AdminTiendas,db.session))
