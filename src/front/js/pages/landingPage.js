...
const CardComentarios = React.lazy(() => import("../component/cardComentarios"));
				...
				<section className="py-20 bg-white dark:bg-gray-800">
					<div className="container mx-auto px-4">
						<div className="max-w-6xl mx-auto">
							<div id="carouselExampleIndicators" className="relative rounded-2xl shadow-2xl overflow-hidden">
